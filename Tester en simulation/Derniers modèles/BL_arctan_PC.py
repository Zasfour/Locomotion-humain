...
def DOC(c1,c2,c3,c4,c5,c6,c7,Xi,Xf,X,Y,THETA,V1,V2):
    ...
    opti.minimize( A_forw(v1,c1* T**0) + A_ang(theta,c2 * T**0) + A_orth(v2,c3 * T**0) + V_forw(v1,c4 * T**0) + V_orth(v2,c5 * T**0) + V_ang(theta,c6 * T**0) + Atan(x,Xf[0],y,Xf[1],c7* T**0))    
...
res = pdfo( PDFO, [0.1,0.1,0.1,0.1,0.2,0.2,0.2],bounds=bounds1, constraints=lin_con1, options=options)
