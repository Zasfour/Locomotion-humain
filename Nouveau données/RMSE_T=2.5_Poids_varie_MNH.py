...
KKT_RMSE_PLAN = np.zeros(17)
KKT_RMSE_ang_rad = np.zeros(17)
KKT_RMSE_ang_degree = np.zeros(17)
...
df.to_csv('RMSE_poids_variable_KKT_MNH_T=2.5.csv', index = True)
KKT5 = pd.read_csv('RMSE_poids_variable_KKT_MNH_T=2.5.csv')
dfi.export(KKT5, 'RMSE_poids_variable_KKT_MNH_T=2.5.png')




BL1_RMSE_PLAN = np.zeros(17)
BL1_RMSE_ang_rad = np.zeros(17)
BL1_RMSE_ang_degree = np.zeros(17)
...
df.to_csv('RMSE_poids_variable_BL1_MNH_T=2.5.csv', index = True)
KKT5 = pd.read_csv('RMSE_poids_variable_BL1_MNH_T=2.5.csv')
dfi.export(KKT5, 'RMSE_poids_variable_BL1_MNH_T=2.5.png')




PDFO_RMSE_PLAN = np.zeros(17)
PDFO_RMSE_ang_rad = np.zeros(17)
PDFO_RMSE_ang_degree = np.zeros(17)
...
df.to_csv('RMSE_poids_variable_PDFO_MNH_T=2.5.csv', index = True)
KKT5 = pd.read_csv('RMSE_poids_variable_PDFO_MNH_T=2.5.csv')
dfi.export(KKT5, 'RMSE_poids_variable_PDFO_MNH_T=2.5.png')
