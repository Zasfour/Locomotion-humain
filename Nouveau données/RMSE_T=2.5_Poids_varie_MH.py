...
df.to_csv('RMSE_poids_variable_KKT_MH_T=2.5.csv', index = True)
KKT5 = pd.read_csv('RMSE_poids_variable_KKT_MH_T=2.5.csv')
dfi.export(KKT5, 'RMSE_poids_variable_KKT_MH_T=2.5.png')
...
df.to_csv('RMSE_poids_variable_BL1_MH_T=2.5.csv', index = True)
KKT5 = pd.read_csv('RMSE_poids_variable_BL1_MH_T=2.5.csv')
dfi.export(KKT5, 'RMSE_poids_variable_BL1_MH_T=2.5.png')
...
df.to_csv('RMSE_poids_variable_PDFO_MH_T=2.5.csv', index = True)
KKT5 = pd.read_csv('RMSE_poids_variable_PDFO_MH_T=2.5.csv')
dfi.export(KKT5, 'RMSE_poids_variable_PDFO_MH_T=2.5.png')
